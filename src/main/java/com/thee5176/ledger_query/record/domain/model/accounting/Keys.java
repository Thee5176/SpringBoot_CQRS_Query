 ...
 */
package com.thee5176.ledger_query.record.domain.model.accounting;


import com.thee5176.ledger_query.record.domain.model.accounting.tables.CodeOfAccount;
import com.thee5176.ledger_query.record.domain.model.accounting.tables.LedgerItems;
import com.thee5176.ledger_query.record.domain.model.accounting.tables.Ledgers;
import com.thee5176.ledger_query.record.domain.model.accounting.tables.records.CodeOfAccountRecord;
import com.thee5176.ledger_query.record.domain.model.accounting.tables.records.LedgerItemsRecord;
import com.thee5176.ledger_query.record.domain.model.accounting.tables.records.LedgersRecord;
import com.thee5176.ledger_query.record.domain.model.credential.tables.Users;
import com.thee5176.ledger_query.record.domain.model.credential.tables.records.UsersRecord;
...
public class Keys {
    ...
    public static final ForeignKey<LedgersRecord, UsersRecord> LEDGERS__LEDGER_ITEMS_USER_FKEY = Internal.createForeignKey(Ledgers.LEDGERS, DSL.name("ledger_items_user_fkey"), new TableField[] { Ledgers.LEDGERS.OWNER_ID }, com.thee5176.ledger_query.record.domain.model.credential.Keys.USERS_PKEY, new TableField[] { Users.USERS.ID }, true, ForeignKeyRule.SET_NULL, ForeignKeyRule.NO_ACTION);
}
