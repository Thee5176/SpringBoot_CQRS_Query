 ...
 */
package com.thee5176.ledger_query.record.domain.model.credential.tables.records;
...
public class UsersRecord extends UpdatableRecordImpl<UsersRecord> {
     ...
     */
    public UsersRecord(String id, String username, String password, Boolean isEnabled, Boolean isAccountNonExpired, Boolean isCredentialsNonExpired, Boolean isAccountNonLocked, String firstname, String lastname, String email) {
        super(Users.USERS);
     ...
     * Create a detached, initialised UsersRecord
     */
    public UsersRecord(com.thee5176.ledger_query.record.domain.model.credential.tables.pojos.Users value) {
        super(Users.USERS);
